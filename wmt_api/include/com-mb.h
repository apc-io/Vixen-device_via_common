...
#define MBIO_SYNC_CACHE			_IOW (MB_IOC_MAGIC,15, unsigned long) // I: user address
#define MBIO_GET_VERSION		_IOR (MB_IOC_MAGIC,16, unsigned long) // O: mb driver version
#define MBIO_SET_CACHABLE		_IOW (MB_IOC_MAGIC,17, unsigned long) // O: property of MB
#define MBIO_CLR_CACHABLE		_IOW (MB_IOC_MAGIC,18, unsigned long) // O: property of MB
