...
/* VEIOSET_ENCODE_LOOP: application send encode data to driver through the IOCTL
                   (blocking mode in driver)
*/                   
#define VEIOSET_ENCODE_LOOP       _IOWR(VE_IOC_MAGIC, 4, ve_ioctl_cmd)
