...
//#define PATH_LCD_BACKLIGHT      "/sys/class/leds/lcd-backlight/brightness"
#define PATH_LCD_BACKLIGHT      "/sys/class/backlight/pwm-backlight.0/brightness"
        ...
        struct light_state_t const* state)
{
    ...
    ALOGD("set_light_backlight: state->color=0x%02x, brightness = %d\n", state->color, brightness);  //debuged by howayhuo
    pthread_mutex_lock(&g_lock);
    g_backlight = brightness;
    err = write_int(PATH_LCD_BACKLIGHT, brightness);
