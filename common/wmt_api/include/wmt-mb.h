...
// get mb driver version
unsigned long wmt_mb_version(int fd);
// sync mb cache
void wmt_mb_cache_sync(int fd, void *user);
// allocate continual memory with property
void *wmt_mb_alloc_ext(int fd, int size, int prot, int flags);
