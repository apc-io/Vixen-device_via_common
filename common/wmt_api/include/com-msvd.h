...
#define API_MSVD_VERSION        100   /* version: 0.01.00 */
...
typedef struct{
    ...
    unsigned int constraint_set_flag[4];
    unsigned int direct8x8Flag;
    unsigned int vc1_psf;
    unsigned int aspectRateInfo;
} msvd_out_property_t;
